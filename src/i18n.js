...
const translations = {
  zh: {
    ...
    card_status: '状态',
    card_permission_notify_title: '🔔 AGY 等待本地确权',
    card_permission_notify_tip: '⚠️ AGY 正在等待操作确认，请前往本地终端处理。',
    card_permission_options_label: '可选操作',
    card_question_notify_title: '🔔 AGY 等待本地决策',
    card_question_notify_tip: '❓ AGY 正在等待回答，请前往本地终端选择。',
  ...
  en: {
    ...
    card_status: 'Status',
    card_permission_notify_title: '🔔 AGY Awaiting Local Approval',
    card_permission_notify_tip: '⚠️ AGY is waiting for action confirmation. Please handle it in your local terminal.',
    card_permission_options_label: 'Available Options',
    card_question_notify_title: '🔔 AGY Awaiting Local Decision',
    card_question_notify_tip: '❓ AGY is waiting for an answer. Please select an option in your local terminal.',
